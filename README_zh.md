...
默认 RSS 源保持小而精：Simon Willison、OpenAI News、Google DeepMind Blog、Hugging Face Blog、GitHub Blog、GitHub Changelog、Latent Space、Import AI 和 GitHub Trending。建议后续逐步增加 RSS，避免低质量转载把日报挤满。
